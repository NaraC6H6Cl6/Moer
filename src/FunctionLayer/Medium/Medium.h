...
public:
    ...
    virtual MediumSampleEvent sampleEvent(Point3d pos, Point2d sample) const = 0;

    virtual Spectrum evalEmittance(Point3d pos) const = 0;
